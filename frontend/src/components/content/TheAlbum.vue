  ...
  <div v-else-if="album" class="p-8 flex-col">
    ...
    <div class="p-5 pl-0 flex items-center gap-4">
      ...
      >
        <img
          :src="
            store.isPlaying ? '/images/icons/pause.png' : '/images/icons/play-button-arrowhead.png'
          "
          alt="play"
          class="w-4 h-4"
        />
      ...
      >
        <div class="w-4 h-4 flex items-center justify-center relative">
          ...
          >
            ...
            />
            <img class="filter invert cursor-pointer w-full h-full" src="/images/icons/pause.png" />
          </button>
        </div>
